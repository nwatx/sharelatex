    ...
    <div className="w-full relative bg-white">
      <div className="max-w-7xl px-2 mx-auto">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <nav className="hidden sr-only md:flex space-x-10">
          ...
          --> */}
              <div className="sr-only absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
            ...
            Leaving: "transition ease-in duration-150"
              ...
              To: "opacity-0 translate-y-1"
          --> */}
              <div className="sr-only absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a
                      href="#"
          ...
          <div className="hidden sr-only md:flex items-center justify-end md:flex-1 lg:w-0">
            <a
              href="#"
